...
const Main = (props: IMainProps) => (
  <div className="w-full px-1 text-gray-700 antialiased">
    ...
    <div className="w-full">
      <header className="border-b border-gray-300 flex justify-between items-center py-2">
        <div className="ml-10">
          <h1 className="text-3xl font-bold text-gray-900 flex items-center uppercase gap-2 text-[#7f7600]">
        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <Link target="_blank" rel="noreferrer" className="flex gap-2 bg-white dark:bg-gray-200 justify-center px-4 py-2 border-2 rounded-md my-6 text-xs font-light shadow-lg cursor-pointer no-underline" href="https://nfts2me.com">
                <div className="mt-1">Created by</div>
                <Image className="h-6" width={24} height={24} src="https://nfts2me.com/assets/images/logo.svg" alt="NFTs2Me logo" />
                <div className="mt-1 font-bold">NFTs2Me Team</div>
              </Link>
            </div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <a href="https://twitter.com/nfts2me" target="_blank" className="text-gray-700 hover:text-black dark:hover:text-white">
