...
//   if (xdcxRewardEvents.length) {
//     const { _amount } = xdcxRewardEvents[0].args;
//     if (lastRewardsTime) {
//       if (
//         lastRewardAmount
//           .sub(_amount)
  ...
  if (
    ...
    findings.push(
      Finding.fromObject({
        ...
        alertId: "XDCx-COMPLETE-DELEGATION",
        protocol: protocol,
        severity: FindingSeverity.Critical,
        type: FindingType.Info,
        metadata: {
  ...
  if (diffHours > START_UNDELEGATION_DELAY) {
    findings.push(
      Finding.fromObject({
        ...
        alertId: "XDCx-START-UNDELEGATION",
        protocol: protocol,
        severity: FindingSeverity.Critical,
        type: FindingType.Info,
        metadata: {
  ...
  if (
    ...
    findings.push(
      Finding.fromObject({
        ...
        alertId: "XDCx-UNDELEGATION-UPDATE",
        protocol: protocol,
        severity: FindingSeverity.Critical,
        type: FindingType.Info,
        metadata: {
  ...
  if (
    ...
    findings.push(
      Finding.fromObject({
        ...
        alertId: "XDCx-COMPLETE-UNDELEGATION",
        protocol: protocol,
        severity: FindingSeverity.Critical,
        type: FindingType.Info,
        metadata: {
